...
const getCustomerInfo = ai.defineTool(
    {
      ...
      inputSchema: z.object({
        customerId: z.string().describe('The ID of the customer to fetch information for.'),
      }),
...
const redeemReward = ai.defineTool(
    {
        ...
        inputSchema: z.object({
            ...
            customerId: z.string().describe('The ID of the customer redeeming the reward.'),
        }),
        outputSchema: z.object({
            success: z.boolean(),
            message: z.string(),
...
const LoyaltyProgramAssistantInputSchema = z.object({
  ...
  customerId: z.string().describe('The ID of the customer who is making the query.'),
});
...
const prompt = ai.definePrompt({
  ...
  El ID del cliente que pregunta es {{{customerId}}}. Siempre debes pasar este ID a cualquier herramienta que lo requiera.
