  ...
  const handleLookup = async (e: React.FormEvent) => {
    ...
    try {
        ...
        if (querySnapshot.empty) {
            ...
            // Found customer(s), redirect to selection page
            toast({ title: '¡Bienvenido!', description: 'Cargando tus programas de lealtad.' });
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4">
        ...
        <Card className="w-full max-w-md">
            <CardHeader>
                <CardTitle>Bienvenido a tus programas de lealtad</CardTitle>
                <CardDescription>
                    Ingresa tu correo electrónico para ver todas tus tarjetas de lealtad, puntos y recompensas.
                </CardDescription>
            </CardHeader>
            <CardContent>
