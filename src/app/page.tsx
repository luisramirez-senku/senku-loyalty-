        ...
        <div className="container flex h-16 max-w-screen-2xl items-center">
            ...
            <div className="flex flex-1 items-center justify-end gap-2">
                 <Button variant="ghost" asChild>
                    <Link href="/customer/find">Acceso Clientes</Link>
                </Button>
                 <Button variant="ghost" asChild>
        ...
        <section id="ai-features" className="py-20">
            <div className="container mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-muted-foreground mt-4 max-w-3xl mx-auto">Nuestra IA no es un truco. Es tu socio estratégico para entender, atraer y deleitar a tus clientes de maneraste eran imposibles.</p>
                </div>
